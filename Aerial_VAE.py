...
from myDataFeederVAE import RegDataGenerator
#import tables
import h5py
#original_dim = 784
...
conv2 = Conv2D(24, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(pool1)
print ("conv2 shape:",conv2.shape)
conv2 = Conv2D(24, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv2)
print ("conv2 shape:",conv2.shape)
...
vae.save('C:/Users/arbaaz/Desktop/Deep Learning/Keras/Keras/model_VAE_2.h5')
print('\nModel saved')
