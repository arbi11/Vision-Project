...
class RegDataGenerator(object):
  ...
  def __init__(self, hdf5_file, option, subtract_mean = True, dim_x = 256, dim_y = 256, dim_z = 5, batch_size = 4, shuffle = True):
      'Initialization'
      self.dim_x = dim_x
      self.dim_y = dim_y
      self.dim_z = dim_z
...
########################
              ...
              gp_val_img = self.hdf5_file['/DS1/val_img']
              gp_train_lab = self.hdf5_file['/DS/train_labels'] 
              gp_val_lab = self.hdf5_file['/DS1/val_labels'] 
